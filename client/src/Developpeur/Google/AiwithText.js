...
const AiwithImageAndText = () => {
    ...
    return (
        <div className="main" >
            <div className="nav">
                <p style={{marginLeft:'20px' , marginTop:'-40px'}}>Gemini</p>
                ...
                <div className="inputContainer">
                    <div style={{ display: 'flex', width: '1000px' }}>
                        <input
                            ...
                            style={{ width: '350px', height: '50px', marginRight: '10px', color:'black' }}
                        />
                ...
                {responses.map((response, index) => (
                    <div key={index}>
                        <div style={{ display: 'flex', alignItems: 'center'  }}>
                            {response.image && <img src={response.image} alt="Response Image" style={{ width: '55px', height: '55px', marginRight: '20px', marginTop:'-410px' }} />}
                            <div style={{ marginLeft: response.image ? '10px' : '0' }}>
                                <img src={geminiIcon} alt="" className="loadingIcon" style={{ width: '25px', height: '25px', marginTop: '70px', marginBottom: '-25px' , marginLeft:'-35px' }} />
                                {response.text.split('\n').map((line, index) => (
