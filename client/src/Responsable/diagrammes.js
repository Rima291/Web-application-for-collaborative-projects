...
import {
  ...
  XAxis,
  YAxis,
} from 'recharts'; // Assurez-vous que vous importez XAxis et YAxis de 'recharts'
  ...
  return (
    <>
      ...
      <div style={{marginTop: '5px', display: 'flex', justifyContent: 'center', width:'700px', marginLeft:'550px' }}>
        <div className="widget" style={{ width: '700px', margin: '0 10px' }}>
          <div className="left">
          ...
          <div className="right">
            <div className="percentage positive">
              {/* Vous pouvez ajouter un affichage de pourcentage ici si nécessaire */}
            </div>
            <PersonOutlinedIcon
              className="icon"
              style={{
